      ...
      <div id="page1" class="webpage1">
        ...
        <Form-item class="form1">
          <Select v-model="formInline.select" placeholder="选择身份">
            <Option value="xuesheng">学生端</Option>
            <Option value="jiaoshi">教师端</Option>
            <Option value="guangli">管理端</Option>
          </Select>
        </Form-item>
        ...
        <Form-item>
          <Button class="button" type="primary" @click="navigator('student')">
            登录
          </Button>
